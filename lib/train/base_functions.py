...
def build_dataloaders(cfg, settings):
    ...
    sampler_mode = getattr(cfg.DATA, "SAMPLER_MODE", "trident_pro")
...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "similarity" in n and p.requires_grad]}
        ]

        for n, p in net.named_parameters():
            if "similarity" not in n:
